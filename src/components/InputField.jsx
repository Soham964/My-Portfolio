...
const InputField = ({ field, label, icon: Icon, formData, handleChange }) => {
  ...
  const getInputClasses = (isTextArea = false) => {
    ...
    const hoverFocusClasses = isFocused
      ? "shadow-[0_4px_12px_rgba(16,185,129,0.4)] border-[#10b981]"
      : "border-white/20 hover:border-[#10b981]";
  ...
  return (
    <div className="relative w-full group">
      {/* Icon and Label */}
      <div className="absolute left-4 top-4 flex items-center space-x-2 text-gray-400 transition-colors group-hover:text-[#10b981]">
        ...
        <label
          ...
          className={`
            ...
            peer-focus:top-2 peer-focus:translate-y-0 peer-focus:text-[#10b981] peer-focus:text-sm
          `}
        >
          {label}
        </label>

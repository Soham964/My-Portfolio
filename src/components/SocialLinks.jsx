...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/soham-datta-a70149246/",
    color: "#0A66C2",
...
const SocialLinks = () => {
  ...
  const [instagram, twitter, github] = otherLinks;
